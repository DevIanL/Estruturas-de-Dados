...
public class EleicaoPrefeito extends Exception{
	...
	public EleicaoPrefeito(Candidato candidato1, Candidato candidato2, Candidato candidato3) throws IllegalArgumentException{
		...
		if (!candidato1.getCargo().equalsIgnoreCase("prefeito") ||
			!candidato2.getCargo().equalsIgnoreCase("prefeito") || 
			!candidato3.getCargo().equalsIgnoreCase("prefeito")) {

			if(!candidato1.getCargo().equalsIgnoreCase("prefeito")){
				throw new IllegalArgumentException("Candidato " + candidato1.getNome() + " nao esta se candidatando a prefeito.");
			}else if (!candidato2.getCargo().equalsIgnoreCase("prefeito")) {
				throw new IllegalArgumentException("Candidato " + candidato2.getNome() + " nao esta se candidatando a prefeito.");
			}else{
				throw new IllegalArgumentException("Candidato " + candidato3.getNome() + " nao esta se candidatando a prefeito.");
			}
		}
	}
	...
	public void registrarVoto(int numeroCandidato) throws IllegalArgumentException {
		if(numeroCandidato < 0){
			throw new IllegalArgumentException("Numero de candidato invalido.");
		}
